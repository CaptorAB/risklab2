...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TimeSeriesChartComponent; });
...
var TimeSeriesChartComponent = TimeSeriesChartComponent_1 = (function () {
    ...
    TimeSeriesChartComponent.updateChart = function (svgChart, timeSeriess, instruments, startDate, endDate, minValue, maxValue, updateAxises) {
        ...
        if ((minValue != null) && (maxValue != null)) {
            ...
            my = timeSeriess.reduce(function (p, c) { return __WEBPACK_IMPORTED_MODULE_1__common_svg_chart__["a" /* SvgChart */].timeSeriesMinMax(c, p); }, {});
        ...
        if (updateAxises)
            svgChart.updateAxises(scales, [0.25, 0.5, 0.75].map(function (d) { return (1 - d) * mx.min + d * mx.max; }), [-2, -1, 0, 1, 2].map(function (d) { return timeSeriess[0].startValue + d * ticky; }).filter(function (d) { return (d < my.max) && (d > my.min); }));
        for (var i = 0; i < timeSeriess.length; i++) {
            var ts = timeSeriess[i];
            var tsitems = ts.items;
            var line = d3.line()
                .x(function (d) { return scales.x(d.timestamp.valueOf()); })
            ...
            var ci = i + 1;
            if (instruments)
                if (instruments.length > i)
                    ci = instruments[i].colorIndex;
...
], TimeSeriesChartComponent.prototype, "instruments", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Number)
], TimeSeriesChartComponent.prototype, "widthHeightRatio", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object)
], TimeSeriesChartComponent.prototype, "margin", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Array])
], TimeSeriesChartComponent.prototype, "timeSeriess", null);
__decorate([
...
], TimeSeriesChartComponent.prototype, "chartContainer", void 0);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TimeSeriesProjectionChartComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TimeSeriesProjectionChartComponent = TimeSeriesProjectionChartComponent_1 = (function () {
    ...
    TimeSeriesProjectionChartComponent.prototype.updateChart = function () {
        ...
        if (!this.svgChart)
            return;
        if (!this._timeSeriess)
            return;
        if (this._timeSeriess.length == 0)
            return;
        ...
        if ((this._mus === undefined) || (this._sigmas === undefined) || (this._projectionYearsTimeSpan === undefined))
            return;
        var tssAdjEnd = [];
        ...
        for (var i = 0; i < n; i++) {
            ...
            tsss.push(tss);
            my = [tss[0], tss[tss.length - 1]].reduce(function (p, c) { return __WEBPACK_IMPORTED_MODULE_3__common_svg_chart__["a" /* SvgChart */].timeSeriesMinMax(c, p); }, my);
        }
        ...
        this.svgChart.updateAxises(this.scales, [-2, -1, 0, 1, 2].map(function (d) { return startProj.valueOf() + d * tickx; }).filter(function (d) { return (d < maxx) && (d > minx); }), [-2, -1, 0, 1, 2].map(function (d) { return tssAdjEnd[0].endValue + d * ticky; }).filter(function (d) { return (d < _this.scales.maxy) && (d > _this.scales.miny); }));
        var v0;
        var area0 = d3.area()
            .x(function (d) { return _this.scales.x(d.x); })
            .y0(function (d) { return _this.scales.y(v0); })
            .y1(function (d) { return _this.scales.y(v0); });
        var area = d3.area()
            .x(function (d) { return _this.scales.x(d.x); })
            .y0(function (d) { return _this.scales.y(d.y0); })
            .y1(function (d) { return _this.scales.y(d.y1); });
        var n = tsss.length;
        for (var i_1 = 0; i_1 < n; i_1++) {
            var ci = i_1;
            if (this._instruments)
                if (this._instruments.length > i_1)
                    ci = this._instruments[i_1].colorIndex - 1;
    ...
    TimeSeriesProjectionChartComponent.prototype.calculateProjection = function (timeSteps, startValue, startDate, endDate, mu, sigma) {
        ...
        return quantiles.map(function (d) { return TimeSeriesProjectionChartComponent_1.logNormalMonthlyQuantileForecast(ts, mu, sigma, d, startValue); });
    };
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Number)
], TimeSeriesProjectionChartComponent.prototype, "widthHeightRatio", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Boolean)
], TimeSeriesProjectionChartComponent.prototype, "showAnnotation", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object)
], TimeSeriesProjectionChartComponent.prototype, "margin", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Boolean)
], TimeSeriesProjectionChartComponent.prototype, "rescale", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], TimeSeriesProjectionChartComponent.prototype, "historyEndValues", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Array])
], TimeSeriesProjectionChartComponent.prototype, "timeSeriess", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], TimeSeriesProjectionChartComponent.prototype, "mus", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], TimeSeriesProjectionChartComponent.prototype, "sigmas", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], TimeSeriesProjectionChartComponent.prototype, "correlations", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], TimeSeriesProjectionChartComponent.prototype, "projectionYearsTimeSpan", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Array])
], TimeSeriesProjectionChartComponent.prototype, "instruments", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_11" /* ViewChild */])('chart'),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* ElementRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* ElementRef */]) === "function" && _a || Object)
], TimeSeriesProjectionChartComponent.prototype, "chartContainer", void 0);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Markowitz; });
var Markowitz = (function () {
    ...
    Markowitz.base0to1 = function (A) {
        ...
        for (i = 0; i < n; i++)
            ret[i + 1] = Markowitz.base0to1(A[i]);
        return ret;
    };
    Markowitz.base1to0 = function (A) {
        ...
        var ret = [], i, n = A.length;
        for (i = 1; i < n; i++)
            ret[i - 1] = Markowitz.base1to0(A[i]);
        return ret;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_svg_chart__ = __webpack_require__(41);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BalanceSheetChartComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BalanceSheetChartComponent = (function () {
    ...
    BalanceSheetChartComponent.prototype.adjustTextLines = function (ys, lineHeight, height) {
        ...
        var n = ys.length;
        while (true) {
            ys = ys.map(function (d, i) { return minMax(d, lineHeight * (i + 0.5), height - lineHeight * (ys.length - i - 0.5)); });
            var ms = [];
            var t = 0;
            for (var i = 0; i < n; i++) {
                var m = 0;
                if (i > 0)
                    m -= Math.max(lineHeight - (ys[i] - ys[i - 1]), 0) / 2;
                if (i < (n - 1))
                    m += Math.max(lineHeight - (ys[i + 1] - ys[i]), 0) / 2;
                t += Math.abs(m);
                ms.push(m);
            }
            for (var i = 0; i < (n - 1); i++) {
    ...
    BalanceSheetChartComponent.prototype.calcRects = function () {
        ...
        if (!this._instruments || !this._weights)
            return;
        if (this._instruments.length != this._weights.length)
            return;
        var s = 0;
    ...
    BalanceSheetChartComponent.prototype.onDrag = function (d) {
        if (!d.parent._weights)
            return;
        if (d.parent._weights.length != 2)
            return;
    ...
    BalanceSheetChartComponent.prototype.updateChart = function (transitionDuration) {
        ...
        if (!this.svgChart)
            return;
        var isNumeric = function (n) { return !isNaN(n) && isFinite(n); };
        var allNumeric = this._weights.reduce(function (p, c) { return p && isNumeric(c); }, true);
        if (!allNumeric)
            return;
        this.calcRects();
        if (!this.rects)
        ...
        var ts = this.adjustTextLines(this.rects.map(function (d) { return _this.scales.y(d.start + d.weight / 2); }), this.lineHeight, this.scales.y(1.0));
        var updsel = this.svgChart.chart.selectAll("text.key")
            .data(this.rects);
        ...
        updsel
            ...
            .attr('dx', dx)
            .attr('dy', function (d, i) { return ts[i] + _this.textOffsetY; })
            .text(function (d, i) { return _this._instruments[i].name; });
        updsel
            .text(function (d, i) { return _this._instruments[i].name; })
            .transition()
        ...
        updsel
            .exit()
            .remove();
        var updsel = this.svgChart.chart.selectAll("text.value")
            .data(this.rects);
        ...
        updsel
            ...
            .attr('dx', dx)
            .attr('dy', function (d, i) { return ts[i] + _this.textOffsetY; })
            .text(function (d, i) { return toPercent(d.weight); });
        updsel
            .transition()
            .duration(transitionDuration)
            .text(function (d, i) { return toPercent(d.weight); })
        ...
        var modfixrect = function (sel) {
            return sel
                .attr("class", function (d, i) { return "fixed c" + (_this._instruments[i].colorIndex); })
                .attr("x", function (d) { return _this.scales.x(barStart); })
                .attr("width", function (d) { return _this.scales.x(barEnd) - _this.scales.x(barStart); })
                .attr("y", function (d) { return _this.scales.y(d.start); })
                .attr("height", function (d) { return _this.scales.y(d.start + d.weight) - _this.scales.y(d.start); });
        };
        ...
        var moddragrect = function (sel) {
            return sel
                .attr("x", function (d) { return _this.scales.x(barStart); })
                .attr("width", function (d) { return _this.scales.x(barEnd) - _this.scales.x(barStart); })
                .attr("y", function (d) { return _this.scales.y(d.start) - 5; })
                .attr("height", 10);
        };
        var fixrectdata = this.rects.slice(1);
        fixrectdata.forEach(function (d) { d.parent = _this; });
        sel = this.svgChart.chart.selectAll("rect.moveable").data(fixrectdata);
        moddragrect(sel.transition().duration(transitionDuration));
        moddragrect(sel.enter().append("rect").attr("class", "moveable").call(d3.drag().on("drag", this.onDrag)));
        sel.exit().remove();
    };
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Number)
], BalanceSheetChartComponent.prototype, "widthHeightRatio", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object)
], BalanceSheetChartComponent.prototype, "margin", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", String)
], BalanceSheetChartComponent.prototype, "align", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Array])
], BalanceSheetChartComponent.prototype, "instruments", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_3" /* Output */])(),
    __metadata("design:type", Object)
], BalanceSheetChartComponent.prototype, "weightsChange", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Array])
], BalanceSheetChartComponent.prototype, "weights", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_11" /* ViewChild */])('chart'),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* ElementRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* ElementRef */]) === "function" && _a || Object)
], BalanceSheetChartComponent.prototype, "chartContainer", void 0);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CapmChartComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CapmChartComponent = (function () {
    ...
    Object.defineProperty(CapmChartComponent.prototype, "mus", {
        get: function () {
            return this.musAndSigmas.map(function (d) { return d.y; });
        },
        set: function (v) {
    ...
    Object.defineProperty(CapmChartComponent.prototype, "sigmas", {
        get: function () {
            return this.musAndSigmas.map(function (d) { return d.x; });
        },
        set: function (v) {
    ...
    CapmChartComponent.prototype.setMusAndSigmas = function (mus, sigmas) {
        ...
        if (mus)
            ...
            n = sigmas.length;
        if (this.musAndSigmas === undefined)
            this.musAndSigmas = [];
        for (var i = this.musAndSigmas.length; i < n; i++)
            this.musAndSigmas.push({ x: undefined, y: undefined, parent: this });
        ...
        var isNumeric = function (n) { return !isNaN(n) && isFinite(n); };
        var allNumeric = this.musAndSigmas.reduce(function (p, c) { return p && isNumeric(c.x) && isNumeric(c.y); }, true);
        if (!allNumeric)
            return;
        if (this.initialMusAndSigmas === undefined)
            this.initialMusAndSigmas = this.musAndSigmas.map(function (d) { return ({ x: d.x, y: d.y }); });
        this.calcEfficientFrontier();
    };
    CapmChartComponent.prototype.calcEfficientFrontier = function () {
        ...
        var indices = this.musAndSigmas.map(function (d, i) { return i; });
        var mus = this.musAndSigmas.map(function (d) { return d.y; });
        var sigmas = this.musAndSigmas.map(function (d) { return d.x; });
        var maxmuriskfree = this.musAndSigmas.reduce(function (p, c) { return (c.x > 0) ? p : ((p === undefined) ? c.y : Math.max(c.y, p)); }, undefined);
        if (maxmuriskfree != undefined) {
            indices = this.musAndSigmas.map(function (d, i) {
                if ((d.y > maxmuriskfree) || ((d.y == maxmuriskfree) && (d.x <= 0)))
                    return i;
                return -1;
            }).filter(function (d) { return d >= 0; });
            mus = indices.map(function (d) { return mus[d]; });
            sigmas = indices.map(function (d) { return Math.max(sigmas[d], 0.0001); });
            corrs = indices.map(function (d) { return corrs[d]; }).map(function (d) { return indices.map(function (f) { return d[f]; }); });
        }
        var effs = [];
        var weights = [];
        if (mus.length > 1) {
            var mumin = mus.reduce(function (p, c) { return (p === undefined) ? c : Math.min(p, c); }, undefined);
            var mumax = mus.reduce(function (p, c) { return (p === undefined) ? c : Math.max(p, c); }, undefined);
            ...
            numeric.linspace(mumin, mumax, 20).forEach(function (x) {
                ...
                indices.forEach(function (d, i) { return ws[d] = w[i]; });
                weights.push(ws);
            });
        }
        ...
        if (this.latestClick && (weights.length > 0)) {
            if (effs.length > 0) {
                var pws = [];
                if (effs.length > 0) {
                    var sp = new __WEBPACK_IMPORTED_MODULE_4__common_natural_cubic_spline__["a" /* NaturalCubicSpline */](effs.map(function (d) { return _this.scales.x(d.sigma); }), effs.map(function (d) { return _this.scales.y(d.mu); }), false);
                    ...
                    for (var i = 0; i < n; i++) {
                        var spw = new __WEBPACK_IMPORTED_MODULE_4__common_natural_cubic_spline__["c" /* NaturalCubicSplineOneDim */](sp.splinex.xs, weights.map(function (d) { return d[i]; }));
                ...
                this.portfolioWeights = weights[0];
    ...
    CapmChartComponent.prototype.createChart = function () {
        ...
        this.svgChart.chart.append("rect")
            .attr("class", "click")
            .attr("x", 0)
            .attr("y", 0)
        ...
        sel.on("click", function () { _this.onChartClick(sel, _this); });
        ...
        this.svgChart.chart.append("path")
            .attr("class", "line efficientfrontier");
    };
    CapmChartComponent.prototype.onDrag = function (d, i) {
        ...
        var mus = d.parent.musAndSigmas.map(function (d) { return d.y; });
        var sigmas = d.parent.musAndSigmas.map(function (d) { return d.x; });
    ...
    CapmChartComponent.prototype.updatePortfolio = function (chart, portfs, size, sw, transitionDuration) {
        var append = function (sel) { return sel.append("path").attr("fill", "#fff").attr("stroke-width", sw); };
        var f = size / (61 + sw);
        var gsel = chart.selectAll("g.portfolio").data(portfs);
        var mod = function (sel) { return sel.attr("transform", function (d) { return "translate(" + (d.x).toFixed(1) + "," + (d.y).toFixed(1) + ") scale(" + f.toFixed(3) + "," + f.toFixed(3) + ") translate(" + (-1.5 - 61 / 2).toFixed(1) + "," + (-1.5 - 61 / 2).toFixed(1) + ")"; }); };
        mod(gsel.transition().duration(transitionDuration));
        var gsel2 = mod(gsel.enter().append("g").attr("class", "portfolio"));
        ...
        append(gsel2).attr("class", "d1").attr("d", "M62.5,32v25.16c0,1.105-0.896,2-2,2h-57c-1.104,0-2-0.895-2-2V32H62.5z");
        append(gsel2).attr("class", "d2").attr("d", "M27.728,32v-1.993c0-2.489,1.912-4.508,4.272-4.508c2.358,0,4.272,2.019,4.272,4.508V32v3.99c0,2.489-1.914,4.509-4.272,4.509c-2.36,0-4.272-2.02-4.272-4.509V32z");
        gsel.exit().remove();
    };
    CapmChartComponent.prototype.updateChart = function () {
        ...
        if (this._instruments) {
            ...
            sel = this.svgChart.chart.selectAll("g.label")
                .data(ds);
            mod = function (sel) {
                var sel2 = sel
                    .attr("transform", function (d) { return "translate(" + _this.scales.x(d.x).toFixed(2) + "," + (_this.scales.y(d.y).toFixed(2) + 3) + ")"; });
                var mod2 = function (sel) {
                    return sel
                        .attr("style", function (d) { return "text-anchor: " + ((d.anchor == "topleft") ? "end" : "start") + ";"; })
                        .text(function (d) { return d.text; })
                        .attr("x", function (d) { return ((d.anchor == "topleft") ? -1 : 1) * _this._circleRadius; })
                        .attr("y", function (d, i) { return (1.1 * (i + ((d.anchor == "topleft") ? -1.9 : 1.1))).toFixed(1) + "em"; });
                };
                var sel3 = sel2.selectAll("text").data(function (d, i) {
                    ...
                    return [sn, toPercent(d.y, 1) + " / " + toPercent(d.x, 1)].map(function (g) { return ({ text: g, anchor: d.anchor }); });
                });
                mod2(sel3);
            ...
            mod(sel);
            mod(sel.enter().append("g").attr("class", "label"));
            sel.exit().remove();
        }
        if (this.showInitialValues && this.initialMusAndSigmas) {
            sel = this.svgChart.chart.selectAll("circle.initial")
                .data(this.initialMusAndSigmas);
            var calcColor = function (d, i) {
                var ci = i;
                if (_this._instruments)
                    if (_this._instruments.length > i)
                        ci = _this._instruments[i].colorIndex - 1;
            ...
            mod = function (sel) {
                return sel
                    ...
                    .attr("fill", calcColor)
                    .attr("r", function (d) { return _this._circleRadius; })
                    .attr("cx", function (d) { return _this.scales.x(d.x); })
                    .attr("cy", function (d) { return _this.scales.y(d.y); });
            };
            mod(sel);
            mod(sel.enter().append("circle"));
            sel.exit().remove();
        }
        sel = this.svgChart.chart.selectAll("circle.moveable")
            .data(this.musAndSigmas);
        mod = function (sel) {
            return sel
                ...
                if (_this._instruments)
                    if (_this._instruments.length > i)
                        ci = _this._instruments[i].colorIndex;
        ...
        var ms = [];
        if (this.selectedPortfolio && this.showPortfolio)
            ms.push({ x: this.scales.x(this.selectedPortfolio.x), y: this.scales.y(this.selectedPortfolio.y) });
        ...
        var line = d3.line()
            .curve(d3.curveBasis)
            .x(function (d) { return _this.scales.x(d.sigma); })
            .y(function (d) { return _this.scales.y(d.mu); });
        sel = this.svgChart.chart.selectAll("path.line.efficientfrontier").data([{}]);
        var effs = [];
        if (this.efficientFrontierPoints)
            effs = this.efficientFrontierPoints;
        sel
            .datum(effs)
            .transition()
            .duration(this.transitionDuration)
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Boolean)
], CapmChartComponent.prototype, "showPortfolio", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Number)
], CapmChartComponent.prototype, "widthHeightRatio", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object)
], CapmChartComponent.prototype, "margin", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Boolean)
], CapmChartComponent.prototype, "showAnnotation", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Boolean)
], CapmChartComponent.prototype, "showInitialValues", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Number)
], CapmChartComponent.prototype, "_circleRadius", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_11" /* ViewChild */])('chart'),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* ElementRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* ElementRef */]) === "function" && _a || Object)
], CapmChartComponent.prototype, "chartContainer", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_3" /* Output */])(),
    __metadata("design:type", Object)
], CapmChartComponent.prototype, "musChange", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], CapmChartComponent.prototype, "mus", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_3" /* Output */])(),
    __metadata("design:type", Object)
], CapmChartComponent.prototype, "sigmasChange", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_3" /* Output */])(),
    __metadata("design:type", Object)
], CapmChartComponent.prototype, "portfolioWeightsChange", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], CapmChartComponent.prototype, "sigmas", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], CapmChartComponent.prototype, "correlations", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], CapmChartComponent.prototype, "muRiskFree", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Array])
], CapmChartComponent.prototype, "instruments", null);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CaptorLogoComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", String)
], CaptorLogoComponent.prototype, "width", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", String)
], CaptorLogoComponent.prototype, "height", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", String)
], CaptorLogoComponent.prototype, "color", void 0);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CaptorTableComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Array)
], CaptorTableComponent.prototype, "columnHeaders", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Array)
], CaptorTableComponent.prototype, "rowHeaders", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Array)
], CaptorTableComponent.prototype, "rows", void 0);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CorrelationChartComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CorrelationChartComponent = (function () {
    ...
    Object.defineProperty(CorrelationChartComponent.prototype, "positions", {
        set: function (v) {
            var _this = this;
            this._positions = v.map(function (d) { return ({
                x: d.x, y: d.y, parent: _this
            }); });
            this.updateChart();
        },
        enumerable: true,
    ...
    CorrelationChartComponent.prototype.updateChart = function () {
        var _this = this;
        if ((this.svgChart === undefined) || (this._positions === undefined) || (this._circleRadius === undefined))
            return;
        if (this._instruments) {
            sel = this.svgChart.chart.selectAll("text.label").data(this._positions);
            var mod = function (sel) {
                return sel
                    .attr("x", function (d) { return _this._circleRadius + _this.scales.x(d.x); })
                    .attr("y", function (d) { return _this._circleRadius + 10 + _this.scales.y(d.y); })
                    .text(function (d, i) {
                    var ins = _this._instruments[i];
                    if (!ins)
                        return "";
            ...
            mod(sel);
            mod(sel.enter().append("text").attr("class", "label"));
            sel.exit().remove();
        }
        var sel = this.svgChart.chart.selectAll("circle.moveable")
    ...
    CorrelationChartComponent.prototype.coordToString = function (c, n) {
        if (n === undefined)
            n = 2;
        return c.slice(0, n).map(function (d) { return d.toFixed(2); }).join(', ');
    };
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Boolean)
], CorrelationChartComponent.prototype, "showAnnotation", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Number)
], CorrelationChartComponent.prototype, "widthHeightRatio", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Number)
], CorrelationChartComponent.prototype, "_circleRadius", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], CorrelationChartComponent.prototype, "positions", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_3" /* Output */])(),
    __metadata("design:type", Object)
], CorrelationChartComponent.prototype, "positionsChange", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object)
], CorrelationChartComponent.prototype, "margin", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_11" /* ViewChild */])('chart'),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* ElementRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* ElementRef */]) === "function" && _a || Object)
], CorrelationChartComponent.prototype, "chartContainer", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_3" /* Output */])(),
    __metadata("design:type", Object)
], CorrelationChartComponent.prototype, "correlationsChange", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Array])
], CorrelationChartComponent.prototype, "instruments", null);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return NaturalCubicSplineOneDim; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NaturalCubicSpline; });
var Node = (function () {
    function Node(x, y) {
        this.x = x;
        this.y = y;
...
var NaturalCubicSpline = (function () {
    ...
    NaturalCubicSpline.prototype.smoothness = function () {
        ...
        if (this.splinex.xs.length > n)
            n = this.splinex.xs.length;
        for (var i = 0; i <= n; i++) {
            var t = i / n;
...
var AppComponent = (function () {
    function AppComponent() {
        ...
        this.origMus = [0.07, 0.06, 0.048, 0.0069, 0.02, 0.004]; // Assets yearly returns
        this.origSigmas = [0.15, 0.12, 0.1, 0.02, 0.08, 0.0025]; // Assets volatilities
        ...
        this.origCorrs = [[1.000, 0.866, 0.573, -0.223, -0.168, 0.006],
            [0.866, 1.000, 0.509, -0.173, -0.097, 0.138],
            [0.573, 0.509, 1.000, 0.026, 0.006, -0.163],
            [-0.223, -0.173, 0.026, 1.000, 0.780, -0.071],
            [-0.168, -0.097, 0.006, 0.780, 1.000, 0.133],
            [0.006, 0.138, -0.163, -0.071, 0.133, 1.000]];
        this.corrPositions1 = __WEBPACK_IMPORTED_MODULE_3__common_monte_carlo_engine__["a" /* MonteCarloEngine */].calcCorrPositions(this.origCorrs).map(function (d) { return new __WEBPACK_IMPORTED_MODULE_3__common_monte_carlo_engine__["b" /* CorrPosition */](d[0], d[1]); });
        ...
        this.correlationsAsString = this.mc1.correlations.map(function (d, i) { return d.map(function (g, j) { return (j >= i) ? g.toFixed(2) : ""; }); });
        ...
        this.mc3 = new __WEBPACK_IMPORTED_MODULE_3__common_monte_carlo_engine__["a" /* MonteCarloEngine */](this.seed1, [mu2[0] - mu2[1]], [Math.sqrt(sigma1 * sigma1 + sigma2 * sigma2 -
                2 * sigma1 * sigma2 * rho)], [[1]]);
        ...
        this.instruments.push(new __WEBPACK_IMPORTED_MODULE_4__common_instrument__["a" /* Instrument */]("Globala aktier", "GL AKT", "asset", null, 2));
        this.instruments.push(new __WEBPACK_IMPORTED_MODULE_4__common_instrument__["a" /* Instrument */]("Alternativa", "ALT", "asset", null, 3));
        this.instruments.push(new __WEBPACK_IMPORTED_MODULE_4__common_instrument__["a" /* Instrument */]("Bostadsobligationer", "BOST", "asset", null, 4));
        this.instruments.push(new __WEBPACK_IMPORTED_MODULE_4__common_instrument__["a" /* Instrument */]("Lång ränta", "LÅNG R", "asset", null, 5));
        //this.instruments.push(new Instrument("Iris ränta", "IRIS", "asset", null, 5));
        this.instruments.push(new __WEBPACK_IMPORTED_MODULE_4__common_instrument__["a" /* Instrument */]("Nollrisk", "NOLLR", "asset", null, 10));
        ...
        this.instruments.forEach(function (d, i) { return d.index = i; });
        this.assetInstruments = this.instruments.filter(function (d) { return d.type == 'asset'; });
        ...
        this.assetInstrumentsShortName = this.assetInstruments.map(function (d) { return d.shortName; });
        this.assetInstrumentsColumnShortName = [""].concat(this.assetPlusBankInstruments.map(function (d) { return d.shortName; }));
        this.liabilityInstruments = this.instruments.filter(function (d) { return d.type == 'liability'; });
        this.balanceInstruments = this.instruments.filter(function (d) { return d.type == 'balance'; });
        this.solvencyInstruments = this.instruments.filter(function (d) { return d.type == 'solvency'; });
        this.liabilityInstrumentsNoNames = this.instruments.filter(function (d) { return d.type == 'liability'; }).map(function (d) { return new __WEBPACK_IMPORTED_MODULE_4__common_instrument__["a" /* Instrument */](null, null, null, null, d.colorIndex); });
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.sub = this.timer.subscribe(function (t) { return _this.onTimer(t); });
    };
    ...
    AppComponent.prototype.updateSolvencyLegend = function () {
        function update(chart, data) {
            var sel = chart.selectAll("text.legend")
                .data(data);
            var mod = function (sel) {
                return sel
                    .attr("dx", 40).attr("dy", function (d, i) { return 50 + 38 * i; })
                    .text(function (d) { return d.text + " " + (100 * d.value).toFixed(d.decimals) + "%"; })
                    .attr("style", "text-anchor: start");
            };
            mod(sel);
            mod(sel.enter().append("text").attr("class", "legend annotation"));
            sel.exit().remove();
        }
        ...
        update(this.solvencyRatioChart.svgChart.chart, [{ text: "Solvensgrad", value: this.solvencyRatio, decimals: 0 },
    ...
    AppComponent.prototype.calcSolvencyTimeSeriess = function () {
        ...
        if (!this.mc3 || !this.solvencyRatioChart)
            return;
        this.solvencyTimeSeriess = this.mc3.timeSeriess.slice(0);
        if (!this.solvencyRatioChart.scales)
            return;
        ...
        if (!this.solvencyRatioChart)
            return;
        if (!this.solvencyRatioChart.svgChart)
            return;
    ...
    AppComponent.prototype.arrayToString = function (a, n) {
        if (n === void 0) { n = 2; }
        return a.map(function (d) { return d.toFixed(n); }).join(", ");
    };
    AppComponent.prototype.monteCarloToString = function (mc) {
        ...
        var res = "";
        if (mc.mus !== undefined)
            res = "mu = [" + this.arrayToString(mc.mus, 3) + "]" + br;
        if (mc.sigmas !== undefined)
            res += "sigma = [" + this.arrayToString(mc.sigmas, 3) + "]" + br;
        if (mc.correlations !== undefined)
            res += "correlation = [" + mc.correlations.map(function (d, i) { return _this.arrayToString(d.slice(i + 1), 3); }).filter(function (d) { return d.length > 0; }).join(", ") + "]";
        return res;
    };
...
], AppComponent.prototype, "solvencyRatioChart", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], AppComponent.prototype, "weights2", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_3" /* Output */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [])
], AppComponent.prototype, "timeSeriess", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], AppComponent.prototype, "mus", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], AppComponent.prototype, "sigmas", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], AppComponent.prototype, "mus2", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], AppComponent.prototype, "sigmas2", null);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Array])
], AppComponent.prototype, "correlations", null);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SvgChart; });
var SvgChart = (function () {
    function SvgChart(element, widthHeightRatio, margin) {
        if (element === void 0) { element = null; }
        if (widthHeightRatio === void 0) { widthHeightRatio = 1.0; }
        if (margin === void 0) { margin = { left: 0, top: 0, right: 0, bottom: 0 }; }
    ...
    SvgChart.timeSeriesMinMax = function (ts, start) {
        return ts.items.reduce(function (p, c) {
            if ((p.max === undefined) || (c.value > p.max))
                p.max = c.value;
            if ((p.min === undefined) || (c.value < p.min))
                p.min = c.value;
            return p;
        }, start);
    };
    SvgChart.arrayMinMax = function (arr, start) {
        return arr.reduce(function (p, c) {
            if ((p.max === undefined) || (c > p.max))
                p.max = c;
            if ((p.min === undefined) || (c < p.min))
                p.min = c;
            return p;
        }, start);
    };
    ...
    SvgChart.prototype.addArrow = function (x, y, rot, len, text, start, end) {
        ...
        if (text) {
            ...
            sel.append("text")
                .attr("dx", dx).attr("dy", -9).text(text);
        }
        var df = function (c, x, y) { return c + x.toFixed(2) + "," + y.toFixed(2); };
        var s = "M0,0";
        if (start) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return CorrPosition; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MonteCarloEngine; });
...
var MonteCarloEngine = (function () {
    ...
    MonteCarloEngine.rand = function (min, max, count) {
        if (count === undefined)
            return MonteCarloEngine.rand1(min, max);
        var res = [];
    ...
    MonteCarloEngine.prototype.updateTimeSeries = function () {
        if ((this._seed === undefined) || (this._mus === undefined) || (this._sigmas === undefined) || (this._correlations === undefined))
            return;
        if ((this._mus.length < 1) || (this._sigmas.length < 1))
            return;
    ...
    MonteCarloEngine.generateRandomTimeSeriess = function (startDate, endDate, startValue, timestepCount, seed, mus, sigmas, correlations) {
        ...
        for (var i = 0; i < mus.length; i++) {
            ...
            s /= timestepCount;
            randns.push(rs.map(function (d) { return d - s; }));
        }
        var res = [];
        for (var i = 0; i < mus.length; i++) {
            var mu = mmus[i];
